...
tape( 'the function returns an iterator protocol-compliant object (value+done)', function test( t ) {
	...
	it1 = createIterator( values1 );
	it2 = createIterator( values2 );
...
tape( 'the function returns an iterator which returns the intersection of two iterators (value+done)', function test( t ) {
	var expected;
	var values1;
	var values2;
	var actual;
...
tape( 'the function returns an iterator which returns the intersection of two iterators (value+done; objects)', function test( t ) {
	var expected;
	var values1;
	var values2;
	var actual;
...
tape( 'the function returns an iterator which returns the intersection of three iterators (value+done)', function test( t ) {
	var expected;
	var values1;
	var values2;
	var values3;
...
tape( 'the function returns an iterator which returns the intersection of two or more iterators (value+done)', function test( t ) {
	var expected;
	var values1;
	var values2;
	var actual;
...
tape( 'the function supports specifying a function execution context (value+done)', function test( t ) {
	var expected;
	var values1;
	var values2;
	var actual;
